...
import ReactMapGL, {Marker, Popup} from "react-map-gl"; // npm install react-map-gl
...
function App() {
  ...
  const handleMarkerClick = (id,lat,long) => {
    ...
    setViewport({...viewport, latitude: lat, longitude: long, zoom: 4});
...
const handleLogout = () => {
  ...
  return (
    <div className="App">
      ...
      mapStyle={""} onDblClick={handleAddClick}
